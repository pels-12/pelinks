...
function Navbar({ onLoginClick }: NavbarProps) {
  ...
  const menuItems: NavLink[] = [
    ...
    },
    {
      ...
      isRoute: true,
      submenu: [
        { label: 'Real Estate & Property Development', href: '/industries/real-estate', isRoute: true },
        { label: 'Retail & Commercial Businesses', href: '/industries/retail', isRoute: true },
        { label: 'Hospitality (Hotels, Clubs & Restaurants)', href: '/industries/hospitality', isRoute: true },
        { label: 'Government & Public Institutions', href: '/industries/government', isRoute: true },
        { label: 'Education (Schools, Colleges & Universities)', href: '/industries/education', isRoute: true },
        { label: 'Healthcare (Hospitals & Clinics)', href: '/industries/healthcare', isRoute: true },
        { label: 'Banking & Financial Institutions', href: '/industries/banking', isRoute: true },
        { label: 'Oil & Gas, Engineering & Utilities', href: '/industries/oil-gas', isRoute: true },
        { label: 'Religious Organizations & Event Centers', href: '/industries/religious', isRoute: true },
        { label: 'Manufacturing & Industrial Facilities', href: '/industries/manufacturing', isRoute: true },
      ],
    },
